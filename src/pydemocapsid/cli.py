...
def parse_args(argv):
    ...
    parser.add_argument("-L", "-lattice", default=choices[0], choices=choices, help="the hexagonal lattice unit tile")
    parser.add_argument("-s", "-sphericity", default=0, type=float, help="the sphericity value")
    choices = ("levo", "dextro")
    parser.add_argument("-t", "-turn", default=choices[0], choices=choices, help="the Caspar-Klug walk turn")
    choices = ("coor", "ico", "tri")
